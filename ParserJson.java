    ...
    public void parser(){
        ...
        try{
            if (!Input.contains("{")&& !Input.contains("}")) {
                ...
                if (("remove".equals(FirstValue)||"import".equals(FirstValue)||"load".equals(FirstValue)||"save".equals(FirstValue)||"connect".equals(FirstValue))&&!this.Input.contains("}")){
                    ...
                    if (stop!=30) this.Input=getInput().substring(1,this.Input.length()).trim();
                    ...
                    if (stop!=30) this.Input=getInput().substring(1,this.Input.length());
                    else this.Input=null;
                }
                    ...
                    while(!((this.Input.indexOf("{")<this.Input.indexOf("}"))
                        ...
                        stop+=1;
                        if (stop==30) {
                            System.out.println("Вы надоели программе, неверно ввели");
                            break;
                        }
                    }
                    if (stop!=30) this.Input=getInput().substring(1,this.Input.length());
...
//            FileOper.XmlSaveFile(TreeCol.get());
    ...
    public boolean Checker(){
        if(this.Input.charAt(this.Input.length()-1)=='}') return true;
        else return false;
    }
...
//    }
    ...
    public void work()throws NullPointerException{
        try {
            ...
            System.out.println("Неверно введены данные4"); }
//    public void work()throws NullPointerException{
//        try {
